            ...
            <div className="hero-content flex flex-col gap-10 text-center">
              ...
              <div className=" w-full flex flex-col gap-2">
                ...
                <div className="collapse collapse-arrow bg-base-200">
                  ...
                  <div className="collapse-content">
                    <p>
                      These buttons are used to adjust their respective editors.
                    </p>
                  </div>
                </div>
                <div className="collapse collapse-arrow bg-base-200">
                  ...
                  <div className="collapse-content ">
                    <p className="px-2">
                      <span className="font-bold">LocalStorage</span> is used to
                      ensure your code remains intact even after a browser
                      refresh.
                    </p>
                  </div>
                </div>
